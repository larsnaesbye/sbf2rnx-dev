...
pub struct SbfBlockHeader {
    sync: [char; 2],
    // In SBF always set to 0x24, 0x40 = "$@"
    crc: u16,
    id: u16,
    length: u16,
}
...
const PVTCARTESIAN: i16 = 4006;
// Position, velocity, and time in Cartesian coordinates
const PVTGEODETIC: i16 = 4007;
...
// Internal parameters for maintenance and support
...
const EXT_EVENT_PVTCARTESIAN: i16 = 4037;
// Cartesian position at the instant of an event
const EXT_EVENT_PVTGEODETIC: i16 = 4038;
